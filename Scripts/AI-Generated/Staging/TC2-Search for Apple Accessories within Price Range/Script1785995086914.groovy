...
TrueTestScripts.click(findTestObject('AI-Generated/Staging/Page_category_accessories_apple/link_sortByPrice'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Search for Apple Accessories within Price Range_visual_checkpoint')
