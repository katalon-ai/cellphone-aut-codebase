...
"Step 2: Click on label storageColorOption (colorWhite2)"
...
"Step 4: Click on button quantityControl (increase) -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Select Storage Options for a Product and Adjust Quantity_visual_checkpoint')
