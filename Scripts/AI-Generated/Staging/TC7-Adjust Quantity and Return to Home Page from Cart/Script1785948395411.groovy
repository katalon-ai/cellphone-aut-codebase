...
"Step 4: Click on button quantityAdjustment (decrease) -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Adjust Quantity and Return to Home Page from Cart_visual_checkpoint')
