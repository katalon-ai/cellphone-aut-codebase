...
"Step 6: Click on label storageColorOption (colorWhite)"
...
"Step 7: Click on label storageColorOption (storage256Gb)"
...
"Step 9: Click on button quantityControl (decrease) -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Navigate to Product Details and Adjust Quantity for iPhone 16e_visual_checkpoint')
