...
"Step 6: Click on link sortByTitle -> Navigate to page '/product/*'"

TrueTestScripts.click(findTestObject('AI-Generated/Staging/Page_category_accessories_apple/link_sortByTitle'))

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Filter and Sort Apple Accessories by Price and Availability_visual_checkpoint')
