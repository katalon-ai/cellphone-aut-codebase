...
"Step 6: Click on label colorStorageModelOptions (colorBlack)"
...
"Step 7: Click on label colorStorageModelOptions (storage512Gb)"
...
"Step 9: Click on button quantityAdjustment (decreaseIcon) -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Navigate to Product Details and Adjust Quantity for Apple iPhone_visual_checkpoint')
