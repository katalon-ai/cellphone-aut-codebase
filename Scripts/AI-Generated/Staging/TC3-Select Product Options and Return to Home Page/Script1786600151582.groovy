...
"Step 2: Click on label colorStorageOption (colorWhite2)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Select Product Options and Return to Home Page_visual_checkpoint')
