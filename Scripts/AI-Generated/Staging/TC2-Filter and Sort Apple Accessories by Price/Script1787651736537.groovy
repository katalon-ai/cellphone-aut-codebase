...
TrueTestScripts.click(findTestObject('AI-Generated/Staging/Page_category_accessories_apple/link_sortByTitle'))

"Step 7: Click on button clear2 -> Navigate to page ''"

TrueTestScripts.click(findTestObject('AI-Generated/Staging/Page_category_accessories_apple/button_clear2'))

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Filter and Sort Apple Accessories by Price_visual_checkpoint')
