...
"Step 2: Click on label storageColorOptions (colorTeal)"
...
"Step 5: Click on button buy -> Navigate to page '/cart'"

TrueTestScripts.click(findTestObject('AI-Generated/Staging/Page_product/button_buy'))

"Step 6: Click on button cartQuantityAdjustment (increase)"
...
"Step 7: Click on button cartQuantityAdjustment (decrease)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Purchase Apple Product with Shipping Details and Verify Thank You Page_visual_checkpoint')
