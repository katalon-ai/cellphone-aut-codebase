...
"Step 7: Click on label colorStorageOption (storage256Gb)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Navigate to Product Details and Verify Home Page_visual_checkpoint')
