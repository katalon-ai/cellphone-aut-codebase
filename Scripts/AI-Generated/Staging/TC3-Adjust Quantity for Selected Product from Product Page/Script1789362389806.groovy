...
"Step 2: Click on label storageColorOptions (storage256Gb)"
...
"Step 3: Click on label storageColorOptions (cream)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Adjust Quantity for Selected Product from Product Page_visual_checkpoint')
