...
"Step 1: Navigate to https://cellphoneshop-truetest-auto-staging.netlify.app/product/samsung-galaxy-s23-ultra"

TrueTestScripts.navigate("/product/${product_id}")

"Step 2: Click on label colorStorageOptions (storage1Tb)"
...
"Step 3: Click on label colorStorageOptions (colorGreen)"

// Bind values to the variables in the locators of "AI-Generated/Staging/Dynamic Objects/Page_product/label_colorStorageOptions_1"
TrueTestScripts.click(findTestObject('AI-Generated/Staging/Dynamic Objects/Page_product/label_colorStorageOptions_1', ['label_colorStorageOptions_LabelInternalText_1': label_colorStorageOptions_LabelInternalText_1, 'label_colorStorageOptions_css_value_1': label_colorStorageOptions_css_value_1]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Adjust Quantity for Selected Product Options_visual_checkpoint')
