...
"Step 7: Click on label colorStorageOptions (storage512Gb)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Navigate to Product Page and Adjust Quantity for iPhone 16e_visual_checkpoint')
