...
TrueTestScripts.click(findTestObject('AI-Generated/Staging/Page_category_accessories/link_sortByPrice'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Search for Accessories within Price Range and Verify Home Page_visual_checkpoint')
