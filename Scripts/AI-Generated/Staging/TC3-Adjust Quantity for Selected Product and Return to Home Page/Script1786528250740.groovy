...
"Step 2: Click on label colorStorageOption (colorPink)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Adjust Quantity for Selected Product and Return to Home Page_visual_checkpoint')
